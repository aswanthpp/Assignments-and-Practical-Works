...
//
  ...
  Ipv4AddressHelper ipv41,ipv42,ipv43;
  ipv41.SetBase ("10.1.1.0", "255.255.255.0");
   ipv42.SetBase ("10.1.2.0", "255.255.255.0");
ipv43.SetBase ("10.1.3.0", "255.255.255.0");


  Ipv4InterfaceContainer i1 = ipv41.Assign (devices[0]);
 Ipv4InterfaceContainer i2 = ipv42.Assign (devices[1]);
 Ipv4InterfaceContainer i3 = ipv43.Assign (devices[2]);
